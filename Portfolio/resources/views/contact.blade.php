        ...
        <div class="row">
            ...
            <div class="mx-auto col-lg-4 col-md-6 col-12">
                ...
                <ul class="social-links mt-2">
                    <li><a href="https://www.facebook.com/sowad.amit" rel="noopener" class="fab fa-facebook"></a></li>
                    <li><a href="#" rel="noopener"
                            class="fab fa-twitter"></a></li>
                    <li><a href="https://www.instagram.com/sowadlee_theyoungest/" rel="noopener" class="fab fa-instagram"></a></li>
                    <li><a href="https://linkedin.com/in/sowad-ahmed-0a772a209" rel="noopener" class="fab fa-linkedin"></a></li>
