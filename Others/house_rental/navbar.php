...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="autofill.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users "></i></span> Police Verfication</a>
				<a href="nidretrive.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users "></i></span> NID Scan Info</a>
